package com.dxc.SpringSecurity.controller;
...
import com.dxc.SpringSecurity.service.CinemaService;
@RestController
...
public class CinemaController
{
		...
		// http://localhost:8013/cinema/all
		@RequestMapping(value = "/all", method = RequestMethod.GET)
		public List<Cinema> getAllCinema() {
			return this.cinemaService.getAllCinemas();
		}
		// http://localhost:8013/cinema/addCinema
		...
		// http://localhost:8013/cinema/updateCinema
